  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion" style="margin: auto">
        ...
        <li class="nav-item {{ Request::is('profil') ? 'active' : '' }}" data-toggle="tooltip" data-placement="right" title="berita">
            <a class="nav-link" href="{{ url('profil') }}">
              <i class="fa fa-fw fa-pencil"></i>
              <span class="nav-link-text">{{ $setting->menu ? $setting->menu['menu8'] : 'Menu 8' }}</span>
            </a>
        </li>
        <li class="nav-item {{ Request::is('informasi') ? 'active' : '' }}" data-toggle="tooltip" data-placement="right" title="berita">
            <a class="nav-link" href="{{ url('informasi') }}">
              <i class="fa fa-fw fa-pencil"></i>
              <span class="nav-link-text">{{ $setting->menu ? $setting->menu['menu9'] : 'Menu 9' }}</span>
            </a>
        </li>
        <li class="nav-item {{ Request::is('kontak') ? 'active' : '' }}" data-toggle="tooltip" data-placement="right" title="berita">
